    ...
    <Float speed={1.2} floatIntensity={0.7} rotationIntensity={0.25}>
      <group>
        ...
        <mesh ref={ring} rotation={[Math.PI / 2.9, 0, 0]}>
          <torusGeometry args={[1.48, 0.01, 12, 150]} />
...
export default function EarthGlobe() {
  return (
    <Canvas camera={{ position: [0, 0, 4.1], fov: 48 }} dpr={[1, 1.75]} gl={{ antialias: true, alpha: true }}>
      <ambientLight intensity={0.55} />
      <pointLight position={[3, 2, 3]} intensity={2} color="#22d3ee" />
      <pointLight position={[-3, -2, 2]} intensity={1.5} color="#a78bfa" />
      <Sparkles count={44} scale={[3.5, 3.5, 3.5]} size={1.8} speed={0.35} color="#67e8f9" opacity={0.35} />
      <GlobeMesh />
